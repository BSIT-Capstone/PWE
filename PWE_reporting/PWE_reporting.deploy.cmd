...
set _DeploySetParametersFile=%RootPath%PWE_reporting.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%PWE_reporting.zip" (
echo "%RootPath%PWE_reporting.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%PWE_reporting.zip',EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -dest:%_Destination%,EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%PWE_reporting.zip',EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -dest:%_Destination%,EncryptPassword='Encryption password is used only if any deployment setting is marked as secure' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%PWE_reporting.deploy-readme.txt" (
...
start notepad "%RootPath%PWE_reporting.deploy-readme.txt"
)
echo =========================================================
goto :eof
